...
# Les fonctionnalités spatiales de R<br/><img src="animation.gif" alt="sf gif" style="border:0px"/>
...
# Title
mtext(text = "Population in Martinique", side = 3, line = -1)
dev.off()
#                                                                                         .
```
</small>
...
<br/><br/><img src="./img/cartomix.png" alt="science" style="width:600px;border:0px"/>
